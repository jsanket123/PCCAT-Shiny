...
# Define User Interface (UI) for the PCCAT app 
shinyUI(fluidPage(
  #theme = "bootstrap.min.css",
  # App Title
  titlePanel(
    div(img(src="MI_EGLE.png",height = 80, width = '10%', align='left'),
        h1('PCCAT: Principal Component and Clustering Analysis Tool',align = 'center'))),
  
  sidebarLayout(
    position = 'left',
    sidebarPanel(
      #img(src="MI_EGLE.png",height = 80, width = '100%', align='center'),
